...
const AdminDashboard = () => {
  ...
  return (
    <main className="p-8 bg-background min-h-screen">
      <header className="mb-10 flex flex-col md:flex-row justify-between gap-4 md:items-end">
        <div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="bg-muted/30 dark:bg-muted/15">
              <tr>
                <th className="px-8 py-4 text-[10px] font-black uppercase text-muted-foreground tracking-widest">User ID</th>
                <th className="px-8 py-4 text-[10px] font-black uppercase text-muted-foreground tracking-widest">Full Name</th>
                <th className="px-8 py-4 text-[10px] font-black uppercase text-muted-foreground tracking-widest">Year Level</th>
                <th className="px-8 py-4 text-[10px] font-black uppercase text-muted-foreground tracking-widest">Role</th>
            ...
            <tbody className="divide-y divide-border">
              {users.map((user) => (
                <tr key={user.id} className="hover:bg-muted/30 dark:hover:bg-muted/15 transition-colors">
                  <td className="px-8 py-5 font-mono text-xs text-muted-foreground">{user.id}</td>
                  <td className="px-8 py-5 font-bold text-foreground">{user.name}</td>
