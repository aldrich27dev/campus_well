    ...
    <StudentLayout>
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 bg-surface dark:bg-surface-elevated rounded-[2.5rem] p-8 md:p-10 border border-border shadow-xl">
            <div className="flex items-center justify-between mb-8">
               ...
               <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Select your current state</span>
            </div>
                ...
                <button
                  ...
                  className={`flex flex-col items-center p-8 md:p-12 rounded-[2.5rem] border-2 transition-all duration-300 group ${
                    selectedMood === m.label
                      ? 'bg-campus-blue border-campus-blue text-primary-foreground scale-105 shadow-soft'
          ...
          <div className="col-span-12 bg-surface dark:bg-surface-elevated rounded-[2.5rem] p-10 border border-border shadow-xl">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-4">
              <div>
                ...
                <h2 className="text-2xl font-black text-foreground uppercase tracking-tighter mt-1">Weekly Monitoring Trend</h2>
              </div>
            ...
            <div className="mt-12 p-6 bg-muted/40 dark:bg-muted/20 rounded-3xl flex flex-col md:flex-row items-center gap-4 border border-border">
               ...
               <div className="text-center md:text-left">
                 <p className="text-[10px] font-black uppercase text-muted-foreground tracking-widest mb-1">System Intelligence Insight</p>
