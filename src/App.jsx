...
import SessionTimeoutWrapper from './components/SessionTimeoutWrapper'; // <--- NEW: Session tracking management wrapper
...
import ForgotPassword from './pages/ForgotPassword'; // <--- NEW: Account recovery step processing
...
function App() {
  return (
    <SystemProvider>
      <Router>
        {/* SessionTimeoutWrapper automatically logs out inactive users after a specified period */}
        <SessionTimeoutWrapper>
          <Routes>
            ...
            <Route path="/forgot-password" element={<ForgotPassword />} /> {/* <--- NEW: Target route for password recovery link handling */}
