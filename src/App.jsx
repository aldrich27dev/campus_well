...
import Analytics from './pages/Analytics'; // Renamed from CounselorAnalytics for general use
      ...
      <Router>
        <Routes>
          ...
          <Route element={<LayoutWithNavbar />}>
            ...
            <Route path="/admin/analytics" element={<Analytics />} /> {/* <--- FIX: Shared analytics logic */}
          </Route>
